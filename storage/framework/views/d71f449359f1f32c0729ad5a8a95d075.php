...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Dreamella Project'); ?></title>
...
<nav class="site-nav" id="siteNav">
    <div class="container">
        <div class="d-flex align-items-center justify-content-between gap-3">
            ...
            <!-- Brand -->
            <a class="nav-brand" href="<?php echo e(route('home')); ?>" id="nav-brand">
            ...
            <div class="collapse navbar-collapse" id="mainNav">
                <div class="d-flex flex-column flex-lg-row align-items-start align-items-lg-center gap-1 gap-lg-1 mt-3 mt-lg-0 flex-grow-1">
                    <a class="nav-link-item" href="<?php echo e(route('events.index')); ?>" id="nav-events">
                        <i class="bi bi-calendar-event"></i> Event
                    </a>
                    <?php if(auth()->guard()->check()): ?>
                        <?php if(auth()->user()->isAdmin()): ?>
                            <a class="nav-link-item" href="<?php echo e(route('admin.dashboard')); ?>" id="nav-admin">
                                <i class="bi bi-shield-check"></i> Admin
                            </a>
                        <?php else: ?>
                            <a class="nav-link-item" href="<?php echo e(route('transactions.index')); ?>" id="nav-transactions">
                                <i class="bi bi-receipt"></i> Transaksi
                            </a>
                            <a class="nav-link-item" href="<?php echo e(route('my-tickets.index')); ?>" id="nav-tickets">
                ...
                <div class="d-flex flex-column flex-lg-row align-items-start align-items-lg-center gap-2 mt-3 mt-lg-0">
                    <?php if(auth()->guard()->check()): ?>
                        <a class="btn-nav-outline" href="<?php echo e(route('profile.edit')); ?>" id="nav-profile">
                    ...
                    <?php else: ?>
                        <a class="btn-nav-outline" href="<?php echo e(route('login')); ?>" id="nav-login">
                            <i class="bi bi-box-arrow-in-right"></i> Masuk
                        </a>
                        <a class="btn-nav-primary" href="<?php echo e(route('register')); ?>" id="nav-register">
...
<!-- ══════ TOAST ALERTS ══════ -->
<?php if(session('success') || session('status') || $errors->any()): ?>
<div class="alert-wrap" id="alertWrap">
    ...
    <div class="alert-toast danger">
        ...
        <span><?php echo e($errors->first()); ?><?php if($errors->count() > 1): ?> &amp; <?php echo e($errors->count()-1); ?> kesalahan lainnya.<?php endif; ?></span>
        <button class="close-btn" onclick="this.closest('.alert-toast').remove()"><i class="bi bi-x-lg"></i></button>
    </div>
    <?php endif; ?>
</div>
...
<?php /**PATH C:\Herd\ticket\resources\views/layouts/app.blade.php ENDPATH**/ ?>