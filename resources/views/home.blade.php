@extends('layouts.app')
@section('title', 'Dreamella Project — Tiket Event Online')
            ...
            <div class="row align-items-center g-5">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="hero-actions">
                        <a href="{{ route('events.index') }}" id="hero-cta-events" class="btn-primary-glow">
                            <i class="bi bi-calendar-event-fill"></i>
                            Jelajahi Event
                        </a>
                        @guest
                        <a href="{{ route('register') }}" id="hero-cta-register" class="btn-ghost">
                    ...
                    <div class="hero-card-wrap position-relative">
                        ...
                        <div class="hero-feature-card">
                            ...
                            <div class="d-flex align-items-center gap-3 {{ !$loop->last ? 'mb-3' : '' }}">
                                <div style="width:36px;height:36px;border-radius:.5rem;background:{{$step['bg']}};color:{{$step['clr']}};display:flex;align-items:center;justify-content:center;flex-shrink:0;font-size:1rem;">
                                    <i class="bi {{$step['icon']}}"></i>
                                </div>
                                <div style="font-size:.85rem;color:var(--clr-muted);">{{ $step['text'] }}</div>
                                <div class="ms-auto" style="font-size:.7rem;font-weight:700;color:var(--clr-muted);">0{{ $i+1 }}</div>
                            </div>
                            @endforeach
    ...
    <section class="events-section">
        <div class="container">
            <div class="section-header d-flex align-items-end justify-content-between flex-wrap gap-3">
                ...
                <a href="{{ route('events.index') }}" id="link-all-events" class="view-all-link">
                ...
                <div class="col-md-6 col-lg-4 fade-up">
                    <div class="event-card">
                        ...
                        <div class="event-poster-new">
                            ...
                            @endphp
                            <div class="event-poster-bg" style="background: {{ $grad }};">
                                <span style="position:relative;z-index:1;">{{ $event->title }}</span>
                            </div>
                        ...
                        <div class="event-body">
                            ...
                            <h3 class="event-title-new">{{ $event->title }}</h3>

                            <div class="event-meta">
                                <div class="event-meta-item">
                                    <i class="bi bi-calendar3"></i>
                                    <span>{{ $event->event_date->format('d M Y') }} &bull; {{ $event->event_time }}</span>
                                </div>
                                <div class="event-meta-item">
                            ...
                            <div class="event-footer">
                                <div class="event-price">
                                    Rp {{ number_format($event->minimumPrice(), 0, ',', '.') }}
                                    <small>Harga mulai dari</small>
                                </div>
                                <a href="{{ route('events.show', $event) }}" id="event-detail-{{ $event->id }}" class="btn-event">
            ...
            <div class="row g-4 justify-content-center">
                ...
                <div class="col-md-4 fade-up">
                    <div class="payment-card">
                        <span class="pay-icon"><i class="bi {{ $pay['icon'] }}" style="color:var(--clr-primary2)"></i></span>
                        <div class="pay-title">{{ $pay['title'] }}</div>
                        <div class="pay-desc">{{ $pay['desc'] }}</div>
                    </div>
                </div>
                @endforeach
            </div>
            ...
            <div class="cta-banner">
                ...
                <div class="cta-content">
                    ...
                    <div class="d-flex gap-3 justify-content-center flex-wrap">
                        <a href="{{ route('events.index') }}" id="cta-browse-events" class="btn-primary-glow">
                            <i class="bi bi-compass-fill"></i>
                            Jelajahi Event
                        </a>
                        @guest
                        <a href="{{ route('register') }}" id="cta-register" class="btn-ghost">
